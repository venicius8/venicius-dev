...
function App() {
  return (
    <>
      <Header></Header>
      <h1>
        Hey! It's me, <span className="nameEffect">Venícius Miguel</span>
      </h1>

      <h2 id="history">Minha história</h2>
      <p>
        Sou do interior pernambucano, tenho 18 anos, e minha maior paixão é a{" "}
        <u>tecnologia</u>. Todo esse amor veio de...
      </p>

      <h2>E sobre hoje</h2>
      <p>
        Atualmente, estou comprometido a estudar desenvolvimento web 5 horas por
        dia, 5 dias por semanas, desde início de 2025, sem nenhuma falta*. Com
        esse período de tempo, consegui adquirir diversos conhecimentos, como:
      </p>
